...
export class RustParser implements IParser {
  ...
  public detect(filePath: string): boolean { return filePath.endsWith('.rs'); }
  ...
  public getCapabilities(): LanguageCapabilities {
    return {
      supportsFunctions: true, supportsClasses: false, supportsInterfaces: true, // traits
      supportsEnums: true, supportsModules: true, supportsNamespaces: false, supportsDecorators: false,
      supportsAnnotations: true, // attributes
